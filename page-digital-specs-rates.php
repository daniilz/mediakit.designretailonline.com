                    ...
                    <div id="content">
                        ...
                        <div class="content-right">
                          <div class="pdfs-container">
                            ...
                            ?>  
                              <span class="pdf-link"><a href="<?=the_field('pdf_1_link');?>" target="_blank"><img src="/wp-content/themes/drmk/images/PDFlogo.png" alt="pdf" class="PDF_LogoLink"><span class="pdf"><?=the_field('pdf_1_title');?></span></a></span>
                            <?php
                            }
                            ?>
                            <?php 
                            ...
                            ?>    
                              <span class="pdf-link pdf-link-2"><a href="<?=the_field('pdf_2_link');?>" target="_blank"><img src="/wp-content/themes/drmk/images/PDFlogo.png" alt="pdf" class="PDF_LogoLink"><span class="pdf"><?=the_field('pdf_2_title');?></span></a></span>
                            <?php
                            }
                            ?>  
                          </div>
